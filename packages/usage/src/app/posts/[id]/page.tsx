  ...
  return (
    <>
      <header className="mt-2 mb-4">
        <Heading>Post #{post.id.substring(0, 6)}...</Heading>
      </header>
      ...
      <section className="relative overflow-hidden rounded-lg border border-gray-200 p-4 sm:p-6 lg:p-8 max-w-xl mb-4">
        ...
        <p className="text-gray-700 mb-4 last:mb-0">
          <strong className="text-gray-900">Content:</strong> {post.content}
        </p>
        <p className="text-gray-700 mb-4 last:mb-0">
          <strong className="text-gray-900">User Id:</strong> {post.userId}
        </p>
      </section>
